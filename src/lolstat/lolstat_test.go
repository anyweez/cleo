...
func test_compare(first []uint64, second []uint64) bool {
...
func TestOverlap6(t *testing.T) {
	a := []uint64{1371765903, 1373700208, 1381119672, 1381634174, 1386748546, 1386956597, 1389613363, 1389891620, 1390726214, 1391074822, 1392060257, 1392233260, 1392837812}
